...
function ENT:drawInfo()
    ...
    cam.Start3D2D(Pos + Ang:Up() * 20.1, Ang, 0.2)
        draw.WordBox(2, -TextWidth * 0.6 + 5, -12, "Оружие: "..contents, "Trebuchet24", Color(0, 0, 0, 0), Color(0, 0, 0))
    cam.End3D2D()
    ...
    cam.Start3D2D(Pos + Ang:Up() * 20, Ang, 0.14)
        draw.WordBox(2, -TextWidth * 0.9 + 5, -150, "Колличество: "..self:Getcount(), "Trebuchet24", Color(0, 0, 0, 0), Color(0, 0, 0))
    cam.End3D2D()
end
